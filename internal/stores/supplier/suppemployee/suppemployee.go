...
func (s Store) SelectByEmail(ctx context.Context, email string) (item Model, err error) {
	return lyspg.SelectUnique[Model](ctx, s.Db, schemaName, viewName, "email", email)
}
