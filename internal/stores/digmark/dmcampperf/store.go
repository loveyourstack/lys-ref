...
const (
	name           string = "Digmark campaign performance"
	schemaName     string = "digmark"
	tableName      string = "campaign_performance"
	viewName       string = "v_campaign_performance"
	pkColName      string = "id"
	defaultOrderBy string = "day_cet DESC, campaign"
)
...
type Input struct {
	...
	Impressions int          `db:"impressions" json:"impressions" validate:"gte=0"`
	RevenueEur  float64      `db:"revenue_eur" json:"revenue_eur" validate:"gte=0"`
	SpendEur    float64      `db:"spend_eur" json:"spend_eur" validate:"gte=0"`
}
