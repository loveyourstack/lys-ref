...
func MustRunCmd(cliApp *cliapp.App) *cobra.Command {
	return &cobra.Command{
		Use:   "mustRun stepId ...[key=value pairs]", // additional args, if sent, are key/value pairs in the form k1=v1 k2=v2 ...
		Short: "TODO",
		...
		RunE: func(cmd *cobra.Command, args []string) (err error) {
			...
			err = cliApp.ProcSvc.MustRunWithDeps(cmd.Context(), cliApp.Db, runId)
			if err != nil {
				return fmt.Errorf("cliApp.ProcSvc.MustRunWithDeps failed: %w", err)
			}
