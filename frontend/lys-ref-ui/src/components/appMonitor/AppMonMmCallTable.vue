<template>
  ...
  >
    <template #top>
      <l-dt-top :ax="ax" :title="props.title ?? 'Maxmind API calls'" :headers="headers" :excelDlUrl="excelDlUrl" v-model:excludedHeaders="excludedHeaders" @resetTable="resetTable()">
      ...
      <v-row density="compact">
        <v-col>
          <app-mon-mm-call-table-filters @update="refreshItems()" @updateDebounced="refreshItemsDebounced()"
...
import ax from '@/api'
import { type ApiCall } from '@/types/maxmind'
...
const baseUrl = '/a/maxmind/api-calls'
