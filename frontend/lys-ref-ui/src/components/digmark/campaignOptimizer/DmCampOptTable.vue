<template>
  ...
  >
    <template #top>
      <l-dt-top :ax="ax" :title="props.title ?? $t('optimizer.title')" :headers="headers" :excelDlUrl="excelDlUrl" 
        ...
        <v-col class="mb-2">
          ...
          <div class="dt-subtitle">
            ...
            <ul class="mt-1 mb-1">
              ...
              <li>{{ $t('optimizer.p2_list.item_3') }}</li>
              <li>{{ $t('optimizer.p2_list.item_4') }}</li>
              <li>{{ $t('optimizer.p2_list.item_5') }}</li>
            </ul>
          </div>
        </v-col>
      </v-row>
