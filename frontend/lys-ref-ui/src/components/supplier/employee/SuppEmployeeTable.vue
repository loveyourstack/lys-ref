<template>
  ...
  >
    <template #top>
      ...
      <l-dt-top :ax="axToUse" :title="props.title ?? $t('saas.supplier_employees')" :headers="headers" :excelDlUrl="excelDlUrl" v-model:excludedHeaders="excludedHeaders" @resetTable="resetTable()"
