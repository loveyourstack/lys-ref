  ...
  >
    <template #top>
      ...
      <v-row density="comfortable">
        <v-col class="mb-2">
          <div class="dt-subtitle" v-if="props.internal">Internal view: all supplier employees are visible and editable.</div>
          <div class="dt-subtitle" v-else>Tenant view: only employees of the tenant are visible, and are not editable.</div>
        </v-col>
      </v-row>
    </template>
